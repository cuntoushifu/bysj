<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="课题名" prop="thesisName">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="系统类型" prop="leixing">
          <el-input v-model="form.leixing" placeholder="请输入课题号" />
        </el-form-item>
...
<script>
import { listAllTopices, getAllTopices, delAllTopices, addAllTopices, updateAllTopices } from "@/api/admin/allTopices";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('admin/allTopices/export', {
        ...this.queryParams
